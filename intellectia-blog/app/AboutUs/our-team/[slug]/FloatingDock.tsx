...
//           // If section top is above middle of screen, mark it as active
...
//     <>
//       {/* Desktop Dock */}
//       {/* <nav className="hidden md:flex fixed top-6 left-1/2 -translate-x-1/2 z-50 bg-black/80 px-6 py-2 rounded-full shadow-lg backdrop-blur-md">
...
//                   ? "bg-gray-700 text-white no-underline"
...
//       {/* Mobile Dock */}
//       <nav className="flex md:hidden fixed top-4 left-1/2 -translate-x-1/2 z-50 bg-black/80 px-1.5 py-2 rounded-md shadow-lg backdrop-blur-md">
