...
//            <h2 className="text-5xl  text-gray-800 px-6 font-dm-sans font-semibold md:text-20xl mb-10">
//              Our Team
//            </h2>
//            <div>
//             <TeamFilterBar/>
...
const AboutUs = () => {
  ...
  // const handleFilterChange = async (updatedFilters: typeof filters) => {
  ...
  //       member.attributes.TeamMemberName?.toLowerCase().includes(searchTerm)
  //     );
  //   }
  ...
  //     result = result.filter((member) =>
  //       member.attributes.Teampracticeareas?.data?.some(
  //         (area: any) =>
  //           area.attributes.title.toLowerCase() === updatedFilters.practice.toLowerCase()
  //       )
  //     );
  //   }

  //   // Filter by Sector
  //  // Filter by Sector (using SectorTag)
  //   if (updatedFilters.sector) {
  //         result = result.filter(member =>
  //           Array.isArray(member.attributes.sectors?.data) &&
  //           member.attributes.sectors.data.some(
  //             (sector: any) =>
  //               sector.attributes.SectorTag.toLowerCase() === updatedFilters.sector.toLowerCase()
  //           )
  //         );
  //       }
  ...
  //       (member) =>
  //         member.attributes.TeamMemberDesignation?.toLowerCase() ===
