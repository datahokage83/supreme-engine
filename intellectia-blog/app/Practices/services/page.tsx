...
//         <h1 className="text-4xl font-bold mb-6 font-dm-sans text-gray-800">
//           {practice.attributes.title}
//         </h1>

//        {/* Quote */}
//           <p className="text-lg mt-10 text-gray-700 italic mb-4">
//             "{practice.attributes.quote}"
//           </p>
...
//                   ? `http://localhost:1337${sub.attributes.SubAreaImg.data[0].attributes.url}`
//                   : "/placeholder.jpg";
