...
//   const strapipracticearea = await getStrapiData("/api/practice-areas?populate=*");
//   const strapiHomeData = await getStrapiData("/api/home-page?populate=*");
//   const logoURL = "http://localhost:1337" + strapiHomeData.data.attributes.Logo.data.attributes.url;
...
//         {/* Heading */}
//         <p className="font-dm-sans uppercase font-medium text-xl text-gray-800 tracking-wider mb-8">
//           practices we do
//         </p>

//         {/* Cards and Paragraphs side by side */}
//         <div className="flex flex-col lg:flex-row gap-10">
//           {/* Left: Card Grid */}
//           <div className="w-full lg:w-[45%] grid grid-cols-2 gap-x-0 ">
//             {strapipracticearea?.data?.map((area: any) => (
...
//             <p className="font-dm-sans text-xl tracking-wide -mt-1">
//               Our firm provides a broad range of legal services designed to meet the needs of individuals,
//               businesses, and organizations. We are committed to providing expert guidance and practical 
//               solutions across multiple areas of law. With a commitment to professionalism and diligence,
//               we help our clients navigate complex legal matters with confidence and clarity.
//             </p>
//             <p className="font-dm-sans text-xl tracking-wide">
//               From protecting intellectual property and managing property-related transactions to handling 
//               litigation and advising on compliance matters, our team approaches every case with care and 
//               attention to detail. By combining deep expertise with clear communication, we ensure that our
//               clients receive reliable advice, effective representation, and solutions tailored to their
//               unique requirements.
//             </p>
//           </div>
//         </div>
...
//       const baseURL = "http://localhost:1337";
//       const practiceRes = await fetch(baseURL + "/api/practice-areas?populate=*");
//       const practiceData = await practiceRes.json();

//       const homeRes = await fetch(baseURL + "/api/home-page?populate=*");
